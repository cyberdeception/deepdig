...
def parseResultsFile(filename):
    ...
    return [meanAccuracy,overhead,timeElapsed,trials,numpy.mean(statList),numpy.std(statList)]

print 'filename [avgAccuracy, avgOverhead, avgTimeElapsed, numTrials, mean, std]'
