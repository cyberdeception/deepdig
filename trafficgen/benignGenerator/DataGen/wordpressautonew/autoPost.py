...
for i in range(1,2):
    ...
    print userData
    registerUserData = {"username":userData[2],"email":userData[4],"url":"104.154.117.255","app":"wordpress",\
    ...
    for j in range(1,2) :
        ...
        postData ={"url":"104.154.117.255","app":"wordpress","title":mytitle,"body":myText}
